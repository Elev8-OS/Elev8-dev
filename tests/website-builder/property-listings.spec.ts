...
describe('website type', () => {
  it('accepts reviewIds, featuredReviewIds, manualReviews and featuredManualReviewIds', () => {
    const site: Website = {
      id: 'x',
      name: 'X',
      url: 'x.com',
      ...
      manualReviews: [{ id: 'm1', guestName: 'G', rating: 9, text: 'Great', source: 'manual', listingId: 'lst-1', channel: 'airbnb' }],
