...
// Document Center — tenant surface for sharing documents with owners (Flow 10A).
// Upload with category + visibility (all mapped owners of a listing, or one
// specific owner), download via Blob, and browse version history.
      ...
      <DialogContent class="sm:max-w-md">
        ...
        <div class="space-y-3">
          <div class="space-y-1.5">
            ...
            <Input id="doc-title" v-model="uploadTitle" placeholder="e.g. Management Agreement 2026" />
          </div>
          <div class="space-y-1.5">
          ...
          <div v-else class="space-y-1.5">
            <Label for="doc-listing">Listing</Label>
