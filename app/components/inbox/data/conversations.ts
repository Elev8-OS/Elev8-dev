...
export const phoneCalls: Record<string, PhoneCall[]> = {
  ...
  'conv-2': [
    { id: 'call-2-1', conversationId: 'conv-2', direction: 'outbound', status: 'completed', duration: 340, timestamp: '2026-04-24T16:45:00Z', from: 'Komang', to: '+44 7700 900123', staffId: 'staff-2', extensionNumber: '101', note: 'Discussed airport transfer options', summary: 'Komang menghubungi James untuk membahas opsi airport transfer. James meminta penjemputan di bandara tanggal 28 April jam 2 siang. Sudah diatur driver dari pihak ketiga.' },
  ],
  'conv-3': [
