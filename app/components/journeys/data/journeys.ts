...
export const marketplaceTemplates: MarketplaceTemplate[] = [
  ...
  {
    id: 'mkt-instant-booking-payment',
    name: 'Instant Booking Confirmation & Payment Link',
    description: 'Auto-generate payment link and send booking confirmation message to guest inbox immediately upon booking',
    ...
    steps: [
      ...
      },
      {
        id: 'mkt-ibp-s2',
        type: 'message',
        name: 'Send Booking Confirmation & Payment Link',
        messageMode: 'template',
        channel: 'ota',
        templateText: 'Hi {{guest_name}}, your booking for {{property_name}} is confirmed! Please complete your payment using this secure link: {{payment_link}}',
        directive: '',
        contextCheckEnabled: false,
        contextCheckInstruction: '',
        fallback: 'skip',
      ...
      },
      {
        id: 'mkt-ibp-s3',
        type: 'wait',
        name: 'Wait 24 Hours for Payment',
        waitMode: 'time_delay',
        durationDays: 1,
        durationHours: 0,
        durationMinutes: 0,
