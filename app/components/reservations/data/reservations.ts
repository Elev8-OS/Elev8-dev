...
export const initialReservations: ReservationEntry[] = [
  ...
  // --- Owner stays mirrored into Reservations (R47) --------------------------
  // One row per seeded OwnerStay so owner-occupied dates are visible on the
  // Reservations page from a cold start, not only for stays created at runtime.
  // Linked by `bookingNote: 'Owner request {stayId}'` and by the stay's
  // `reservationId`. Status tracks the stay: active -> unverified,
  // pending_approval -> owner_request, cancelled/rejected -> cancelled.
  // Channel stays 'Direct' — there is no 'Owner' channel.
  {
    id: 'ost-res-1',
    guestId: '',
    ...
    bookingNote: 'Owner request ost-1',
    activity: [],
  },
  {
    id: 'ost-res-2',
    ...
    status: 'unverified',
    blockReason: 'Owner stay',
    bookingNote: 'Owner request ost-2',
    activity: [],
  },
  {
    id: 'ost-res-3',
    ...
    status: 'unverified',
    blockReason: 'Owner stay',
    bookingNote: 'Owner request ost-3',
    activity: [],
  },
  {
    id: 'ost-res-4',
    ...
    currency: 'IDR',
    status: 'cancelled',
    blockReason: 'Owner stay — cancelled',
    bookingNote: 'Owner request ost-4',
    activity: [],
  },
  {
    id: 'ost-res-5',
    ...
    bookingNote: 'Owner request ost-5',
    activity: [],
  },
  {
    id: 'ost-res-6',
    ...
    currency: 'IDR',
    status: 'cancelled',
    blockReason: 'Owner stay — rejected',
    bookingNote: 'Owner request ost-6',
    activity: [],
  },
