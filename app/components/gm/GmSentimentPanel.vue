...
<template>
  <Card class="flex h-full flex-col justify-between">
    ...
    <CardContent class="flex min-h-0 flex-1 flex-col justify-between gap-2 overflow-hidden pt-0">
      ...
      <div class="flex flex-col gap-0.5 border-t pt-1.5">
        <NuxtLink
          v-if="hiddenCount"
          to="/inbox"
        ...
        <p v-if="summary.excluded" class="text-[11px] text-muted-foreground truncate">
